(function() {
		...
		const mod = {
			...
			_DataVersionCacheName: 'OLSKServiceWorkerVersionCache-1669795824421',
			...
			async OLSKServiceWorkerDidFetch (event) {
				...
				// if (!(event.request.referrer.match(//play/) && event.request.mode === 'no-cors') && !event.request.url.match(//play/)) {
